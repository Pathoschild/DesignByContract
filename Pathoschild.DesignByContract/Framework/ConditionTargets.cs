...
namespace Pathoschild.DesignByContract.Framework
{
	...
	{
		/// <summary>Annotation that implements <see cref="IMethodPrecondition"/> or <see cref="IMethodPostcondition"/>.</summary>
		Method = AttributeTargets.Constructor | AttributeTargets.Method | AttributeTargets.Parameter,
		...
		ReturnValue = AttributeTargets.Constructor | AttributeTargets.Method | AttributeTargets.Property | AttributeTargets.ReturnValue,

		/// <summary>Annotation that is valid on every supported application element.</summary>
		All = AttributeTargets.Constructor | AttributeTargets.GenericParameter | AttributeTargets.Method | AttributeTargets.Parameter | AttributeTargets.Property | AttributeTargets.ReturnValue
	}
}
