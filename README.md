...
This library requires full trust by default, but you can enable partial trust support by defining the
`ENABLE_PARTIAL_TRUST` build constant. This may increase build time, and isn't actively tested.
