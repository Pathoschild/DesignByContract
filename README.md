...
This library requires full trust as of 1.2; you can use an earlier version with the
`ENABLE_PARTIAL_TRUST` build constant in partial-trust environments. This may increase
build time.
